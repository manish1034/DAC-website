  ...
  return (
    <div className="w-full">
      ...
      <div className="relative h-[100vh] text-white flex flex-col bg-white dark:bg-[#010a18] justify-start">
        ...
        <button className="absolute h-8 w-[8.5rem] bottom-10 left-[30%] text-white dark:text-[#010a18] bg-[#084db8] dark:bg-[#00fff7] rounded-full font-bold shadow-[#5e8cd1] dark:shadow-[#458d8a] shadow-md">View Photos</button>
      </div>
    </div>
  )
}
